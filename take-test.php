...
<div class="container">
  ...
  <div class="row d-flex align-items-center justify-content-center">
    <div class="instruction-box col-12 rounded bg-light border">
      ...
      <div class="box-content">
        This test is called RIASEC Test. This test is used to determine the career that suits you best. The following
        are the instructions that you need to consider while taking up the test. Please read.<br>
    ...
    <div class="test-box col-12 rounded border">
      <div class="header">RIASEC TEST-Select Agree Or Disagree</div>
      <div class="box-content">
        <form action="processors/add_test_attempt.php" class="forms" method="POST">
  ...
  ?>
<center>
<div style="color: white;">You already take the test. Test attempt is limited once only. View your test results instead.</div>
